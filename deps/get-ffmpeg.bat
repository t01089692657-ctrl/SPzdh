...
curl -L -o _tmp\ffmpeg.tgz https://registry.npmjs.org/@ffmpeg-installer/win32-x64/-/win32-x64-4.1.0.tgz
if errorlevel 1 goto :fail
tar -xzf _tmp\ffmpeg.tgz -C _tmp
copy /y _tmp\package\ffmpeg.exe bin\win32-x64\ffmpeg.exe >nul
rmdir /s /q _tmp\package

curl -L -o _tmp\ffprobe.tgz https://registry.npmjs.org/@ffprobe-installer/win32-x64/-/win32-x64-5.1.0.tgz
if errorlevel 1 goto :fail
